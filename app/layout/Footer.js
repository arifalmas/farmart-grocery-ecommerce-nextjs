      ...
      <div className="container">
        ...
        <div className="my-10 flex flex-wrap gap-10 justify-between">
          ...
          <div className="lg:max-w-sm">
            ...
            <p>Register now to get updates on promotions and coupns. Dont worry! We not spam</p>
        ...
        <div className="py-8 flex flex-wrap space-y-3 justify-center md:justify-between items-center border-t ">
          <p className="text-sm">© {new Date().getFullYear()} <a href=" https://arifalmas.netlify.app" className="underline" target="_blank" rel="noreferrer">Arif Almas</a>. No Rights Reserved 🙂. Build for fun.</p>
